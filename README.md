<p align="center">
  <img src="assets/logo/helios-logo-256x256.png" alt="Helios Logo" width="160">
</p>
...
<p align="center">
  ...
  <a href="https://helios.readthedocs.io/zh_CN/latest/?badge=latest">
    <img src="https://readthedocs.org/projects/helios/badge/?version=latest" alt="Documentation Status">
  </a>
</p>

Helios 是一门融合了 **Python 的简洁** 与 **Java 的严谨** 的实验性编程语言。
...
```bash
dist/compiler.exe run examples/hello.helios
```
...
安装后，双击任意 `.helios` 文件即可自动使用 Helios 编译器执行。
...
helios/
├── __init__.py
├── __main__.py       # python -m helios 入口
...
1. **Lexer**：将 `.helios` 源码切分为 Token 流。
...
```bash
python -m helios --help
python -m helios run file.helios
python -m helios repl
python -m helios dis file.helios
```
